...
M_.block_structure.block(1).equation = [ 1 5];
M_.block_structure.block(1).variable = [ 2 4];
...
M_.block_structure.block(2).equation = [ 3 4 2 6];
M_.block_structure.block(2).variable = [ 3 6 1 5];
M_.block_structure.block(2).is_linear = false;
M_.block_structure.block(2).NNZDerivatives = 11;
M_.block_structure.block(2).bytecode_jacob_cols_to_sparse = [2 3 5 6 7 8 12 ];
M_.block_structure.block(1).g1_sparse_rowval = int32([]);
M_.block_structure.block(1).g1_sparse_colval = int32([]);
M_.block_structure.block(1).g1_sparse_colptr = int32([]);
M_.block_structure.block(2).g1_sparse_rowval = int32([4 1 2 1 2 2 4 1 3 4 3 ]);
M_.block_structure.block(2).g1_sparse_colval = int32([2 3 3 5 5 6 6 7 7 8 12 ]);
M_.block_structure.block(2).g1_sparse_colptr = int32([1 1 2 4 4 6 8 10 11 11 11 11 12 ]);
M_.block_structure.variable_reordered = [ 2 4 3 6 1 5];
M_.block_structure.equation_reordered = [ 1 5 3 4 2 6];
...
M_.dynamic_g1_sparse_rowval = int32([3 4 5 6 2 3 1 3 4 4 5 6 4 6 2 2 5 ]);
M_.dynamic_g1_sparse_colval = int32([1 1 4 6 7 7 8 9 9 10 10 11 12 12 16 17 19 ]);
M_.dynamic_g1_sparse_colptr = int32([1 3 3 3 4 4 5 7 8 10 12 13 15 15 15 15 16 17 17 18 ]);
M_.lhs = {
'q'; 
'1'; 
'k'; 
...
M_.block_structure_stat.block(4).equation = [ 2];
...
M_.block_structure_stat.block(5).variable = [ 3];
...
M_.block_structure_stat.variable_reordered = [ 2 4 5 1 3 6];
M_.block_structure_stat.equation_reordered = [ 1 5 6 2 3 4];
...
M_.static_g1_sparse_rowval = int32([2 3 4 1 3 4 2 4 5 2 6 4 ]);
M_.static_g1_sparse_colval = int32([1 1 1 2 3 3 4 4 4 5 5 6 ]);
M_.static_g1_sparse_colptr = int32([1 4 5 7 10 12 13 ]);
M_.params(1) = 0.7;
theta = M_.params(1);
M_.params(2) = 0.04;
r = M_.params(2);
...
save([M_.dname filesep 'Output' filesep 'frictionless_model_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'frictionless_model_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'frictionless_model_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'frictionless_model_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'frictionless_model_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'frictionless_model_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'frictionless_model_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'frictionless_model_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
